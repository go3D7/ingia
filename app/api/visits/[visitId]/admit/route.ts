...
export async function POST(
  ...
  try {
    ...
    const premiseData = visit.premises as { owner_id: string | null } | null;
    ...
    return NextResponse.json({ message: 'Visitor admitted successfully', visit: updatedVisit });

  } catch (error) {
    console.error('Unexpected error in /api/visits/[visitId]/admit:', error);
